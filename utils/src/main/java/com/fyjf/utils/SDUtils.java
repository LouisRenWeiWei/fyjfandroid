...
public class SDUtils {
    ...
    public static String getPDFPath() {
        File file = new File(Environment.getExternalStorageDirectory().getPath()+"/fyjf/pdf/");
        if(!file.exists()){
            file.mkdirs();
        }
        return  Environment.getExternalStorageDirectory().getPath()+"/fyjf/pdf/";
    }
}
