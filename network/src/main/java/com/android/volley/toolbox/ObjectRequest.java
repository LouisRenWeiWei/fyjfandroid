...
//    private final SoftReference<Listener<String>> mListener;
    ...
    public ObjectRequest(String url, Listener<String> responseListener, ErrorListener errorListener) {
        this(Method.GET, url,null, responseListener, errorListener);
    }

    public ObjectRequest(int method, String url, JSONObject requestBody, Listener<String> responseListener, ErrorListener errorListener) {
        this(method, url,requestBody,responseListener, errorListener,null);
    }

    public ObjectRequest(int method, String url, JSONObject requestBody, Listener<String> responseListener,
    ...
    protected void deliverResponse(String response) {
        if(mListener!=null)mListener.onResponse(response.toString());
    }
