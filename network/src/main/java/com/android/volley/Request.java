...
//    private final SoftReference<Response.ErrorListener> mErrorListener;
    ...
    public Request(int method, String url, Response.ErrorListener errorListener,Response.LoadingListener loadingListener) {
        mMethod = method;
        mUrl = url;
//        mErrorListener = new SoftReference<Response.ErrorListener>(listener);
