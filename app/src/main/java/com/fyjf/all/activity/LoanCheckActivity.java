...
* datetime: 
*/
public class LoanCheckActivity extends BaseActivity implements XRefreshView.XRefreshViewListener ,CheckLoanCustomerAdapter.ItemOperationListener{
    @BindView(R.id.back)
    ImageView back;
...
//        xefreshView1.setPreLoadCount(4);
    ...
    private void getData() {
        ...
        vo.request(LoanCheckActivity.this, "resp", "error");
    }
