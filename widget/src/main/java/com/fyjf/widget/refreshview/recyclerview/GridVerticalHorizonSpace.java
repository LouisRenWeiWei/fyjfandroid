package com.fyjf.widget.refreshview.recyclerview;
...
public class GridVerticalHorizonSpace extends RecyclerView.ItemDecoration {
    private int topBottom;
    private int leftRight;

    public GridVerticalHorizonSpace(int topBottom, int leftRight) {
